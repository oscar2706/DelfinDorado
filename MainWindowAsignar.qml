    ...
    Column{
                    ...
                    RowLayout{
                        ...
                        Rectangle{
                            ...
                            RadioButton {
                                ...
                                anchors.centerIn: parent
                                onClicked: {
                                     meseroLista2.restablecerRadioButton()
        ...
        Row{
            ...
            Button{
                ...
                text: "Asignar"
                onClicked: {
                    if(!meseroLista2.verificaCampoVacio())
    ...
    Dialog {
        ...
        onAccepted: {
            ...
            case "1":mesa1.imagen="img/MesaChica_Ocupada.png";
                ...
                textPopup1.text = meseroLista2.getMeseroAsignado(1)
                mesa1.estadoMesa=2;
                break;
            case "2": mesa2.imagen="img/MesaChica_Ocupada.png";
                meseroLista2.setAsignacion(mesa);
                textPopup2.text = meseroLista2.getMeseroAsignado(2)
                mesa2.estadoMesa=2;
                break;
            case "3": mesa3.imagen="img/MesaChica_Ocupada.png";
                meseroLista2.setAsignacion(mesa);
                textPopup3.text = meseroLista2.getMeseroAsignado(3)
                mesa3.estadoMesa=2;
                break;
            case "4": mesa4.imagen="img/MesaChica_Ocupada.png";
                meseroLista2.setAsignacion(mesa);
                textPopup4.text = meseroLista2.getMeseroAsignado(4)
                mesa4.estadoMesa=2;
                break;
            case "5": mesa5.imagen="img/MesaGrande_Ocupada.png";
                meseroLista2.setAsignacion(mesa);
                textPopup5.text = meseroLista2.getMeseroAsignado(5)
                mesa5.estadoMesa=2;
                break;
            case "6": mesa6.imagen="img/MesaGrande_Ocupada.png";
                meseroLista2.setAsignacion(mesa);
                mesa6.estadoMesa=2;
                textPopup6.text = meseroLista2.getMeseroAsignado(6)
                mesa6.estadoMesa=2;
                break;
            case "7": mesa7.imagen="img/MesaGrande_Ocupada.png";
                meseroLista2.setAsignacion(mesa);
                textPopup7.text = meseroLista2.getMeseroAsignado(7)
                mesa7.estadoMesa=2;
                textPopup7.text = meseroLista2.getMeseroAsignado(7)
                mesa7.estadoMesa=2;
                break;
            case "8": mesa8.imagen="img/MesaChica_Ocupada.png";
                meseroLista2.setAsignacion(mesa);
                textPopup8.text = meseroLista2.getMeseroAsignado(8)
                mesa8.estadoMesa=2;
                break;
            case "9": mesa9.imagen="img/MesaChica_Ocupada.png";
                meseroLista2.setAsignacion(mesa);
                textPopup9.text = meseroLista2.getMeseroAsignado(9)
                mesa9.estadoMesa=2;
                break;
            case "10": mesa10.imagen="img/MesaChica_Ocupada.png";
                meseroLista2.setAsignacion(mesa);
                textPopup10.text = meseroLista2.getMeseroAsignado(10)
                mesa10.estadoMesa=2;
                break;
            case "11": mesa11.imagen="img/MesaChica_Ocupada.png";
                meseroLista2.setAsignacion(mesa);
                textPopup11.text = meseroLista2.getMeseroAsignado(11)
                mesa11.estadoMesa=2;
                break;
            }
            meseroLista2.updateItem();
            ventaAsignar.close();
        }
    }
    Popup
