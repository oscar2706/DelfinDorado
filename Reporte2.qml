...
Item {
    ...
    ChartView {
        ...
        PieSeries {
            ...
            size: 0.96
            holeSize: 0.7
            PieSlice { label: categoria1; value: valores1}
            PieSlice { label: categoria2; value: valores2}
            PieSlice { label: categoria3; value: valores3}
            PieSlice { label: categoria4; value: valores4}
            PieSlice { label: categoria5; value: valores5}
            PieSlice { label: categoria6; value: valores6}
            PieSlice { label: categoria7; value: valores7}
            PieSlice { label: categoria8; value: valores8}
            PieSlice { label: categoria9; value: valores9}
            PieSlice { label: categoria10; value: valores10}
        }
        ...
        PieSeries {
            ...
            PieSlice { label: nombre1; value: valores1}
            PieSlice { label: nombre2; value: valores2}
            PieSlice { label: nombre3; value: valores3}
            PieSlice { label: nombre4; value: valores4}
            PieSlice { label: nombre5; value: valores5}
            PieSlice { label: nombre6; value: valores6}
            PieSlice { label: nombre7; value: valores7}
            PieSlice { label: nombre8; value: valores8}
            PieSlice { label: nombre9; value: valores9}
            PieSlice { label: nombre10; value: valores10}
        }
    }
